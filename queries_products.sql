...
INSERT INTO products (name, price, can_be_returned) VALUES ('table', 125.00, 'false');
...
INSERT INTO products (name, price, can_be_returned) VALUES ('nike air max 1', 199.00, 't');

--Display only the products that can_be_returned.

SELECT can_be_returned, name FROM products;
